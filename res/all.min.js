...
var VER='3.31.1',DEBUG=false,LOCALE='en-US';
...
!function(e,t,o,n){"use strict";e.fn.swipe=function(n){n=e.extend({onSwipedLeft:!1,onSwipedRight:!1,onSmallSwipe:!1,onSwipeStart:!1,onClick:!1,onDoubleClick:!1,onFinished:!1,threshold:20,clickThreshold:150,doubleClickThreshold:200,noSwipeInside:".caption",swipeoutSpeed:300,overThreshold:.25},n);var i=function(e){return[e.outerWidth(),e.outerHeight()]},a=function(e){return e.touches&&1===e.touches.length?[Math.round(e.touches[0].pageX),Math.round(e.touches[0].pageY)]:null!==e.clientX?[Math.round(e.pageX),Math.round(e.pageY)]:null};return this.each(function(){var r,u,l,s,c,h,p,d,f,g=e(this),m=g.parent(),T=g.data("lsw_ns")||"lsw_"+Math.floor(1e4*Math.random()),w=!0,S=!0,C=!0,N=!0,v=!1,y=null,O=(g.hasClass("audio")||g.hasClass("video"),function(e){clearTimeout(null),typeof n.onFinished===FUNCTION&&n.onFinished.call(g[0],e)}),I=function(e){D(e),typeof n.onClick===FUNCTION&&n.onClick.call(g[0],e)},U=function(e,t){S||(D(t),S=!0,e?typeof n.onSwipedRight===FUNCTION&&n.onSwipedRight.call(g[0],t):typeof n.onSwipedLeft===FUNCTION&&n.onSwipedLeft.call(g[0],t))},D=function(e){"mouseup"===e.type||"mouseout"===e.type?(g.off("mouseup."+T+" mouseout."+T),o.off("mousemove."+T)):e.type===TOUCH.END&&g.off(TOUCH.END+"."+T)},M=function(e,t,o,n){var i={};Array.isArray(e)||(e=[e,d[1]]),i.transform=f+e[0]+","+e[1]+")",typeof o!==UNDEF&&o?(i.transition="transform "+o+"ms ease-out",null!==t&&(i.transition+=",opacity "+o+"ms ease-out",i.opacity=t)):i.transition="none",typeof n===FUNCTION&&g.one("transitionend",n),g.css(i)},E=function(e){return!!(w||N||e.originalEvent.touches&&e.originalEvent.touches.length>1)||(e.preventDefault(),C?p=[function(e){return e.touches&&1===e.touches.length?Math.round(e.touches[0].pageX):null!==e.pageX?Math.round(e.pageX):null}(e.originalEvent)-h[0],0]:((p=a(e.originalEvent))[0]-=h[0],p[1]-=h[1]),M([d[0]+p[0],d[1]+p[1]]),!1)},k=function(e){if(N)return!0;if(e.preventDefault(),y&&(clearTimeout(y),y=null),w=!0,(c=(new Date).getTime())-s>50&&function(e){return Array.isArray(e)?Math.sqrt(Math.pow(e[0],2)+Math.pow(e[1],2)):Math.abs(e)}(p)>n.threshold){var t=1+n.swipeoutSpeed/(c-s);if(g.data({scrolling:!0,swipeEnded:!0,taplength:c-s}),C){i=d[0]+p[0]*t;u[0]>=r[0]||p[0]>0&&i-r[0]/2>u[0]*(n.overThreshold-.5)||i+r[0]/2<u[0]*(.5-n.overThreshold)?(M(i,0,n.swipeoutSpeed,O),U(p[0]>0,e)):(M(i,null,n.swipeoutSpeed),D(e))}else{var o=parseInt(g.css("top")),i=[d[0]+p[0]*t,p[1]>0?Math.min(-o,d[1]+p[1]*t):Math.max(-o+u[1]-r[1],d[1]+p[1]*t)];Math.abs(p[0])>Math.abs(p[1])&&(i[0]-r[0]/2>u[0]*(n.overThreshold-.5)||i[0]+r[0]/2<u[0]*(.5-n.overThreshold))?(M(i,0,n.swipeoutSpeed,O),U(p[0]>=0,e)):(M(i,null,n.swipeoutSpeed),D(e))}v=!1}else p[0]||p[1]?(!function(e){D(e),typeof n.onSmallSwipe===FUNCTION&&n.onSmallSwipe.call(g[0],e)}(e),M(d,null,100),v=!1):n.onDoubleClick?v?((new Date).getTime()-c<n.doubleClickThreshold?function(e){D(e),typeof n.onDoubleClick===FUNCTION&&n.onDoubleClick.call(g[0],e)}(e):I(e),v=!1):(v=!0,y=setTimeout(function(e){I(e),v=!1},n.doubleClickThreshold+10,e)):I(e);return!1};g.add(o).off("."+T),g.data("lsw_ns",T),t.on("resize."+T,function(){clearTimeout(l),l=setTimeout(function(){u=i(m)},50)}),g.attr("draggable","false").on(TOUCH.START+"."+T+" dragstart."+T+" mousedown."+T,function(t){if(v)return!1;if("touchstart"!==t.type&&t.preventDefault(),"mousedown"===t.type&&1!==t.which)return function(e){D(e),typeof n.onRightClick===FUNCTION&&n.onRightClick.call(g[0],e)}(t),!0;if(pageZoomed()||t.originalEvent.touches&&t.originalEvent.touches.length>1||n.noSwipeInside&&e(t.target).closest(n.noSwipeInside).length||"A"===t.target.nodeName||"INPUT"===t.target.nodeName||"BUTTON"===t.target.nodeName||"AUDIO"===t.target.nodeName||"VIDEO"===t.target.nodeName&&t.target.controls&&(ISIOSDEVICE||t.offsetY>e(t.target).height()-60))return N=!0,!0;N=!1,w=!1,v=!1,g.data({scrolling:!0,swipeEnded:!1,taplength:0}),s=(new Date).getTime(),h=a(t.originalEvent),u=i(m),r=i(g),C=u[1]>=r[1],p=[0,0];var l=g.getMatrix();return d=[l[4],l[5]],f="matrix("+l.slice(0,4).join(",")+",",function(e){"mousedown"===e.type?(g.on("mouseup."+T+" mouseout."+T,k),o.on("mousemove."+T,E)):e.type===TOUCH.START&&g.on(TOUCH.END+"."+T,k),v=!1}(t),function(e){typeof n.onSwipeStart===FUNCTION&&n.onSwipeStart.call(g[0],e)}(t),S=!1,"touchstart"===t.type}).on(TOUCH.MOVE+"."+T+" drag."+T,E).on("removeSwipe."+T,function(){setTimeout(function(){g.data("scrolling",!1)},20),g.removeAttr("draggable"),g.add(o).off("."+T)}).on("selectstart."+T,function(e){return e.preventDefault(),!1})})}}(jQuery,jQuery(window),jQuery(document));
